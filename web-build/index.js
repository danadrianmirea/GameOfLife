...
// include: C:\Users\adi\AppData\Local\Temp\tmpp3jarqi5.js
...
Module['FS_createPath']("/", "Font", true, true);
    ...
    loadPackage({"files": [{"filename": "/Font/monogram.ttf", "start": 0, "end": 10468}], "remote_package_size": 10468});

  })();

// end include: C:\Users\adi\AppData\Local\Temp\tmpp3jarqi5.js
// include: C:\Users\adi\AppData\Local\Temp\tmpcln4g9st.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\adi\AppData\Local\Temp\tmpcln4g9st.js
// include: C:\Users\adi\AppData\Local\Temp\tmpdaqmd0o3.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\adi\AppData\Local\Temp\tmpdaqmd0o3.js
...
var ASM_CONSTS = {
  2134412: () => { if (document.fullscreenElement) return 1; },  
 2134458: () => { return document.getElementById('canvas').width; },  
 2134510: () => { return parseInt(document.getElementById('canvas').style.width); },  
 2134578: () => { document.exitFullscreen(); },  
 2134605: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 2134678: () => { if (document.fullscreenElement) return 1; },  
 2134724: () => { return document.getElementById('canvas').width; },  
 2134776: () => { return screen.width; },  
 2134801: () => { document.exitFullscreen(); },  
 2134828: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 2134961: () => { return window.innerWidth; },  
 2134987: () => { return window.innerHeight; },  
 2135014: () => { if (document.fullscreenElement) return 1; },  
 2135060: () => { return document.getElementById('canvas').width; },  
 2135112: () => { return parseInt(document.getElementById('canvas').style.width); },  
 2135180: () => { if (document.fullscreenElement) return 1; },  
 2135226: () => { return document.getElementById('canvas').width; },  
 2135278: () => { return screen.width; },  
 2135303: () => { return window.innerWidth; },  
 2135329: () => { return window.innerHeight; },  
 2135356: () => { if (document.fullscreenElement) return 1; },  
 2135402: () => { return document.getElementById('canvas').width; },  
 2135454: () => { return screen.width; },  
 2135479: () => { document.exitFullscreen(); },  
 2135506: () => { if (document.fullscreenElement) return 1; },  
 2135552: () => { return document.getElementById('canvas').width; },  
 2135604: () => { return parseInt(document.getElementById('canvas').style.width); },  
 2135672: () => { document.exitFullscreen(); },  
 2135699: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 2135757: () => { return screen.width; },  
 2135782: () => { return screen.height; },  
 2135808: () => { return window.screenX; },  
 2135835: () => { return window.screenY; },  
 2135862: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 2135915: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 2135986: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 2136043: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 2136299: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 2136370: () => { if (document.fullscreenElement) return 1; },  
 2136416: () => { return window.innerWidth; },  
 2136442: () => { return window.innerHeight; },  
 2136469: () => { if (document.pointerLockElement) return 1; }
};
