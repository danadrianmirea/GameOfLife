...
// include: D:\msys64\tmp\tmp0pwt78fu.js
...
// end include: D:\msys64\tmp\tmp0pwt78fu.js
// include: D:\msys64\tmp\tmpmf587ub7.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: D:\msys64\tmp\tmpmf587ub7.js
// include: D:\msys64\tmp\tmpalaji_yn.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: D:\msys64\tmp\tmpalaji_yn.js
...
var ASM_CONSTS = {
  103036: () => { if (document.fullscreenElement) return 1; },  
 103082: () => { return Module.canvas.width; },  
 103114: () => { return parseInt(Module.canvas.style.width); },  
 103162: () => { document.exitFullscreen(); },  
 103189: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 103262: () => { if (document.fullscreenElement) return 1; },  
 103308: () => { return Module.canvas.width; },  
 103340: () => { return screen.width; },  
 103365: () => { document.exitFullscreen(); },  
 103392: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 103525: () => { return window.innerWidth; },  
 103551: () => { return window.innerHeight; },  
 103578: () => { if (document.fullscreenElement) return 1; },  
 103624: () => { return Module.canvas.width; },  
 103656: () => { return parseInt(Module.canvas.style.width); },  
 103704: () => { if (document.fullscreenElement) return 1; },  
 103750: () => { return Module.canvas.width; },  
 103782: () => { return screen.width; },  
 103807: () => { return window.innerWidth; },  
 103833: () => { return window.innerHeight; },  
 103860: () => { if (document.fullscreenElement) return 1; },  
 103906: () => { return Module.canvas.width; },  
 103938: () => { return screen.width; },  
 103963: () => { document.exitFullscreen(); },  
 103990: () => { if (document.fullscreenElement) return 1; },  
 104036: () => { return Module.canvas.width; },  
 104068: () => { return parseInt(Module.canvas.style.width); },  
 104116: () => { document.exitFullscreen(); },  
 104143: ($0) => { Module.canvas.style.opacity = $0; },  
 104181: () => { return screen.width; },  
 104206: () => { return screen.height; },  
 104232: () => { return window.screenX; },  
 104259: () => { return window.screenY; },  
 104286: () => { return window.devicePixelRatio; },  
 104322: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 104375: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 104426: () => { Module.canvas.style.cursor = 'none'; },  
 104463: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 104719: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 104770: () => { if (document.fullscreenElement) return 1; },  
 104816: () => { return window.innerWidth; },  
 104842: () => { return window.innerHeight; },  
 104869: () => { if (document.pointerLockElement) return 1; }
};
